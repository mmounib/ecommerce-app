      ...
      <div className="flex gap-24 flex-wrap">
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-4">
            <h1 className="bg-favorite py-4 px-4 rounded-[5px] text-white font-semibold">
              Shop With Us
            </h1>
          ...
          return (
            <div className="flex flex-col items-center mx-auto gap-4">
              ...
              <div className="flex flex-col gap-3.5">
                {link.Links.map((lk) => (
                  <Link to={lk.url} className="font-light text-lg text-black">
                    {lk.title}
                  </Link>
                ))}
              </div>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex gap-8">
            <img src="../../../src/assets/stripe.svg" alt="Stripe" className="w-[100px] h-[50px] "/>
            <img src="../../../src/assets/paypal.svg" alt="Paypal" className="w-[100px] h-[100px] "/>
            <img src="../../../src/assets/mastercard.svg" alt="Mastercard" className="w-[100px] h-[70px] "/>
            <img src="../../../src/assets/visa.svg" alt="Mastercard" className="w-[100px] h-[70px] "/>
          </div>
        </div>
      </div>
      <div className=" mt-20 flex justify-between w-full items-center">
          <p className="text-base font-light text-black">@2023 Ecommerce all rights reserved</p>
